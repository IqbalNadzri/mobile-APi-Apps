...
import 'package:haulage_driver/Equipment%20Page/Trailer/Trailer.dart';
...
class FirstTrailer extends StatefulWidget {
  const FirstTrailer({super.key, this.fullname, this.role, this.division, this.branch, this.equipment_category, this.equipment_name, this.user_id,});
  ...
  @override
  State<FirstTrailer> createState() => _FirstTrailerState();
}

class _FirstTrailerState extends State<FirstTrailer> {
  ...
  Future<String?> postData(int? user_id, String? inputField, String? date, String? latlong) async {
    ...
    try {
      ...
      if(response.statusCode == 200) {
        ...
        print('DEDDEDDED $jsonSerialid');
        String? serialIdString = jsonSerialid.toString();
        print('POST request Successfully');
        return serialIdString;
      } else {
                            ...
                            children: [
                              SizedBox(
                                ...
                                child: TextFormField(
                                  ...
                                  readOnly: true,
                                  onTap: () {
                                    selectDateTime.selectDateTime(context, (fn) { }, selectedDateTime, _controllerDate);
                                    _selectDateTime(context);
                                  },
                      ...
                      child: Center(
                        child: Column(
                          children: [
                            ...
                            const Text(
                              'Please Enter the Vehicle Odometer',
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                fontWeight: FontWeight.bold,
                                fontSize: 20,
              ...
              InkWell(
                onTap: () async {
                  ...
                  if (jsonSerialid == "this equipment doesn`t exist") {
                    _showErrorDialog("This equipment doesn't exist and Serial id null");
                    return;
                  }
                  else if (_controllerInputField.text.isEmpty || _controllerOdometer.text.isEmpty || _controllerDate.text.isEmpty || latlong.isEmpty) {
