...
import 'package:haulage_driver/Equipment%20Page/Forklift/Forklift.dart';
...
class FirstForklift extends StatefulWidget {
  const FirstForklift({
    super.key,
    this.fullname,
    this.role,
    ...
    this.equipment_no,
    this.date,
    this.front_left_tyre,
    this.front_right_tyre,
    this.rear_right_tyre,
    this.turn_table,
    this.equipment_name,
  });
  ...
  final int? user_id;
  final String? date;
  final String? front_left_tyre;
  final String? front_right_tyre;
  final String? rear_right_tyre;
  final String? turn_table;

  @override
  State<FirstForklift> createState() => _FirstForkliftState();
}

class _FirstForkliftState extends State<FirstForklift> {
  String equipment_no = '';
        ...
        child: Scaffold(
                      ...
                      child: Center(
                        child: Column(
                          children: [
                            ...
                            const Text(
                              'Enter Equipment No or Plate No:',
                                ...
                                child: TextFormField(
                                  ...
                                  onTap: () {
                                    selectDateTime.selectDateTime(
                                        context, (fn) {}, selectedDateTime, _controllerDate);
                                    _selectDateTime(context);
                                  },
                      ...
                      child: Center(
                        child: Column(
                          children: [
                            ...
                            Text('Please Enter the vehicle Odometer',
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                fontWeight: FontWeight.bold,
                                fontSize: 20,
          ...
          bottomNavigationBar: Row(
            ...
            children: [
              InkWell(
                onTap: () async {
                  String? jsonSerialid = await postData(
                    widget.user_id,
                    _controllerInputField.text,
                    _controllerDate.text,
                    latlong,
                  );
                  ...
                  // Navigate to the next page if everything is okay
                  Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => ForkliftPage(
                      fullname: widget.fullname,
                      role: widget.role,
