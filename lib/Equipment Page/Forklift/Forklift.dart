...
import 'package:haulage_driver/Equipment%20Page/Forklift/Submit.dart';
...
class ForkliftPage extends StatefulWidget {
  const ForkliftPage({
    Key? key,
    this.fullname,
    this.role,
  ...
  @override
  State<ForkliftPage> createState() => _ForkliftPageState();
}

class _ForkliftPageState extends State<ForkliftPage> {
          ...
          ElevatedButton(
            ...
            onPressed: isSubmitEnabled
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => SubmitForklift(
                    fullname: widget.fullname,
                    role: widget.role,
                    branch: widget.branch,
                    division: widget.division,
