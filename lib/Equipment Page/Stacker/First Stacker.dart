...
import 'package:haulage_driver/Equipment%20Page/Stacker/Stacker.dart';
...
class FirstStacker extends StatefulWidget {
  const FirstStacker(
      {super.key,
        this.fullname,
        this.role,
  ...
  @override
  State<FirstStacker> createState() => _FirstStackerState();
}

class _FirstStackerState extends State<FirstStacker> {
