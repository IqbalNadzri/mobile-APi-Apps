...
class SubmitStacker extends StatefulWidget {
  const SubmitStacker({Key? key, this.fullname, this.role, this.branch, this.division, this.equipment_no, this.user_id});
  ...
  @override
  State<SubmitStacker> createState() => _SubmitStackerState();
}

class _SubmitStackerState extends State<SubmitStacker> {
  @override
